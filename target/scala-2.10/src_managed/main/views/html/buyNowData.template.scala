...
"""),format.raw/*339.1*/("""{"""),format.raw/*339.2*/("""
	...
	if (x==null || x=="")
	  """),format.raw/*454.4*/("""{"""),format.raw/*454.5*/("""
	  alert("Appllicant Block-1 phonecell must be filled");
	  return false;
	...
	if (x==null || x=="")
	  """),format.raw/*541.4*/("""{"""),format.raw/*541.5*/("""
	...
	if (x==null || x=="")
	  ...
	  return false;
	  """),format.raw/*589.4*/("""}"""),format.raw/*589.5*/("""
						...
						<div style="background-color:white;border-radius:20px;width:95%;padding:10px;" >
							<table border="0" >
								<tr>
									...
									<td width="20" ></td>
									<td>Salesman</td>
									<td><input autocomplete="off" type="text" id=buyNowForm("Salesman") name="Salesman" onblur="if(onlyletters(this)==false)this.value=''" tabindex=15></td>
								</tr>
								<tr>
									<td>Last Name</td>
								...
								<tr>
									...
									<td>
										...
										<img src="""),_display_(Seq[Any](/*644.21*/routes/*644.27*/.Assets.at("images/calender.png"))),format.raw/*644.60*/(""" ></a>
									</td>
								</tr>
								<tr>
									...
									<td>
										...
										<img src="""),_display_(Seq[Any](/*655.21*/routes/*655.27*/.Assets.at("images/calender.png"))),format.raw/*655.60*/(""" ></a>
									</td>
								</tr>
								<tr>
									<td>Address</td>
								...
								<tr>
									...
									<td>
										...
										<img src="""),_display_(Seq[Any](/*698.21*/routes/*698.27*/.Assets.at("images/calender.png"))),format.raw/*698.60*/(""" ></a>
									</td>
									<td width="20" ></td>
									<td>Previous Job</td>
								...
								<tr>
									<td>How'd you hear about <br>us-choose one</td>
									<td>
